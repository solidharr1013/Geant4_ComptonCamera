...
int main(int argc,char** argv)
{
  ...
  runManager->SetUserInitialization(new ComptonDetectorConstruction());
  ...
  runManager->SetUserInitialization(new ComptonActionInitialization());
/*************************
