...
: G4VUserDetectorConstruction(),
  ...
  fLayer2Log(nullptr),
  fLayer3Log(nullptr),
  fLayer1Thickness(8.*mm),
  fLayer2Thickness(8.*mm),
  fLayer3Thickness(8.*mm),
  fCell1Side(2.*mm),
  fCell2Side(2.*mm),
  fCell3Side(2.*mm)
{
...
G4VPhysicalVolume* ComptonDetectorConstruction::Construct()
{
  ...
  G4double layer1ZPosition = -1.9*cm, layer2ZPosition = 0., layer3ZPosition = 1.9*cm;
  ...
  G4ThreeVector boardPos1 = G4ThreeVector(0,0,-12.8*mm),
                boardPos2 = G4ThreeVector(0,0,6.2*mm),
                boardPos3 = G4ThreeVector(0,0,25.2*mm);
...
void ComptonDetectorConstruction::ConstructMaterial(){
    ...
    G4Element* Si = man->FindOrBuildElement("Si", false);
    G4Element* Lu = man->FindOrBuildElement("Lu", false);
    G4Element* Gd = man->FindOrBuildElement("Gd", false);
    G4Element* Ca = man->FindOrBuildElement("Ca", false);
